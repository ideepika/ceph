...
wait_for_image_present ${CLUSTER2} ${POOL} ${image} 'present' ${image_id}
wait_for_status_in_pool_dir ${CLUSTER2} ${POOL} ${image} 'up+stopped' 'resync invalid, remote image is non-primary'
